...
const Sidebar = (props) => {
    ...
    return (react_1.default.createElement(reactstrap_1.Row, null,
        ...
        // }
        `),
        react_1.default.createElement(reactstrap_1.Col, { sm: 12, lg: 2, className: `sidebar bg-dark text-light` },
            react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("h5", null, props.orgName),
                react_1.default.createElement("h6", null, props.userName),
        ...
        react_1.default.createElement(reactstrap_1.Col, { sm: 12, lg: 10 },
            react_1.default.createElement(reactstrap_1.Row, null,
                react_1.default.createElement(reactstrap_1.Col, { sm: 12, className: `menubar bg-dark text-light` },
                    react_1.default.createElement(reactstrap_1.Row, null,
            ...
            react_1.default.createElement(reactstrap_1.Row, null,
                react_1.default.createElement(reactstrap_1.Col, { sm: 12, className: `main ${props.mainBG === undefined ? "bg-white" : props.mainBG}` },
