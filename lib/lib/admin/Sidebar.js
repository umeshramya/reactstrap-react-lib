...
class Sidebar extends react_1.Component {
    ...
    dispalyEachLink(eachLink, index) {
        if (eachLink.panel !== undefined) {
            ...
            return (react_1.default.createElement(reactstrap_1.Col, { sm: 12, key: index, style: Styles.sidebarLi },
                react_1.default.createElement(link_1.default, { href: eachLink.link === undefined ? "" : eachLink.link, key: index }, eachLink.name)));
        }
    }
    render() {
