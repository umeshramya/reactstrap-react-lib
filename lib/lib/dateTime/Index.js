...
function Index(props) {
    const [dateTime, setDateTime] = react_1.useState(props.setDateTime);
    const setDate = (e) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(reactstrap_1.Input, { type: 'time', value: dateTime.substring(11, 19), onChange: (e) => setTime(e) })));
}
