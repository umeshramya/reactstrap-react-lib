...
function Delete(props) {
    ...
    const submitHandle = (_curUri, _curObj, _onSuccess, _onError, _validation = () => "") => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let res;
            if (_curObj[0] === "GET") {
                res = yield axios_1.default.get(_curUri, props.AxiosRequestConfig).then(res => res);
            }
            else if (_curObj[0] === "DELETE") {
                res = yield axios_1.default.delete(_curUri, props.AxiosRequestConfig).then(res => res);
            }
            else if (_curObj[0] === "PUT") {
                res = yield axios_1.default.put(_curUri, _curObj[1], props.AxiosRequestConfig).then(res => res);
            }
            else {
                // default method
                res = yield axios_1.default.post(_curUri, _curObj[1], props.AxiosRequestConfig).then(res => res);
            }
        ...
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, null,
                react_1.default.createElement(ModelP_1.default, { ref: modRef, Ok: (e) => {
                        ...
                        (_a = modRef.current) === null || _a === void 0 ? void 0 : _a.close();
                    }, modelTitle: "Do you want to delete data ?", modelText: "Press Ok to delete data from server \n Press cancel to exit" }),
                react_1.default.createElement(reactstrap_1.Form, { onSubmit: (e) => {
                        var _a;
                        e.preventDefault();
                        (_a = modRef.current) === null || _a === void 0 ? void 0 : _a.show();
                    } },
                    react_1.default.createElement(ButtonP_1.default, { text: "Delete", color: "danger", ref: butRef, disabled: false })),
