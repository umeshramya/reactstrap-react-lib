...
function Delete({ curUri: uri, id, onSuccess, onError, successCallBack, errorCallback }) {
    const butRef = react_1.useRef(null);
    const modRef = react_1.useRef(null);
    const alerRef = react_1.useRef(null);
    const submitHandle = (_curUri, _curObj, _onSuccess, _onError) => __awaiter(this, void 0, void 0, function* () {
