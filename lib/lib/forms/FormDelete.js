...
function Delete(props) {
    ...
    const [recaptchaToken, setrecaptchaToken] = react_1.useState(null);
    react_1.useEffect(() => {
        var _a;
        ...
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, null,
                react_1.default.createElement(ModelP_1.default, { ref: modRef, Ok: (e) => {
                        ...
                        (_a = modRef.current) === null || _a === void 0 ? void 0 : _a.close();
                    }, modelTitle: "Do you want to delete data ?", modelText: "Press Ok to delete data from server, Press cancel to exit" }),
                react_1.default.createElement(reactstrap_1.Form, { onSubmit: (e) => {
                        ...
                        if (props.recpthaSetting) {
                            ...
                            grecaptcha.ready(function () {
                                grecaptcha.execute(props.recpthaSetting.siteKey, { action: props.recpthaSetting.action }).then(function (token) {
                                    var _a;
