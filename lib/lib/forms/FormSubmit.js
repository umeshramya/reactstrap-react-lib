...
var ButtonP_1 = __importDefault(require("../ButtonP"));
var AlertP_1 = __importDefault(require("../AlertP"));
var ModelP_1 = __importDefault(require("../ModelP"));
var FormSubmit = function (_a) {
    var curObj = _a.curObj, curUri = _a.curUri, Inputs = _a.Inputs, reset = _a.reset;
    var butRef = react_1.useRef();
    var modRef = react_1.useRef();
    var alerRef = react_1.useRef();
    var submitHandle = function (curUri, curObj) { return __awaiter(void 0, void 0, void 0, function () {
        var res, error_1;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(curUri, curObj).then(function (res) { return res; })];
                case 1:
                    res = _h.sent();
                ...
                case 2:
                    ...
                    (_g = alerRef.current) === null || _g === void 0 ? void 0 : _g.alertError(error_1);
                    return [3 /*break*/, 3];
    ...
    return (react_1.default.createElement(reactstrap_1.Container, null,
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, null,
                react_1.default.createElement(ModelP_1.default, { ref: modRef, Ok: function (e) {
                        var _a;
                        submitHandle(curUri, curObj);
                        (_a = modRef.current) === null || _a === void 0 ? void 0 : _a.close();
                    } }),
                react_1.default.createElement(reactstrap_1.Form, { onSubmit: function (e) {
                        var _a;
                        e.preventDefault();
