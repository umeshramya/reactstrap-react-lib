...
const FormSubmit = ({ curObj, curUri, Inputs, reset = () => { }, onSuccess, onError, successCallBack, errorCallback, validation = () => "", AxiosRequestConfig = {}, triggerSubmit, triggerReset, showResetButton = false }) => {
        ...
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, null,
                ...
                react_1.default.createElement(reactstrap_1.Form, { onSubmit: (e) => {
                    ...
                    react_1.default.createElement(reactstrap_1.Row, null,
                        react_1.default.createElement(reactstrap_1.Col, null,
                            react_1.default.createElement(ButtonP_1.default, { text: "Submit", ref: butRef, disabled: submitDisable })),
                        showResetButton ?
                            react_1.default.createElement(reactstrap_1.Col, null,
