...
const FormSubmit = ({ curObj, curUri, Inputs, reset, onSuccess, onError, successMessage, errorMessage }) => {
    const butRef = react_1.useRef(null);
    const modRef = react_1.useRef(null);
    const alerRef = react_1.useRef(null);
    const submitHandle = (curUri, curObj, onSuccess = (res) => { }, onError = (res) => { }) => __awaiter(void 0, void 0, void 0, function* () {
...
function successMessage(res, successMessage) {
