    ...
    const submitHandler = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (previewSource) {
                ...
                (_d = alerRef.current) === null || _d === void 0 ? void 0 : _d.alertSuccess(props.onSuccess(res));
            }
        }
        catch (error) {
            console.log(error);
            (_e = alerRef.current) === null || _e === void 0 ? void 0 : _e.alertError(props.onError(error));
        }
        finally {
        ...
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, null,
                react_1.default.createElement(ModelP_1.default, { ref: modRef, Ok: () => __awaiter(this, void 0, void 0, function* () {
                        var _g;
                        (_g = modRef.current) === null || _g === void 0 ? void 0 : _g.close();
                        yield submitHandler();
