...
function NextAndPrevious({}) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, { className: "justify-content-center" },
                react_1.default.createElement(gr_1.GrCaretPrevious, { onClick: (e) => previous(e), style: { cursor: "pointer" } })),
            react_1.default.createElement(reactstrap_1.Col, { className: "justify-content-center" },
                react_1.default.createElement(reactstrap_1.Input, { type: "number", value: pageNo, onChange: (e) => pageNoHandle(e), width: "23px" })),
            react_1.default.createElement(reactstrap_1.Col, { className: "justify-content-center" },
                react_1.default.createElement(gr_1.GrCaretNext, { onClick: (e) => next(e), style: { cursor: "pointer" } })))));
}
