...
function Pagination({ pageFrom = "Server", firstPage = () => __awaiter(this, void 0, void 0, function* () { return 1; }), lastPage = () => __awaiter(this, void 0, void 0, function* () { return 1; }), nextPage = () => __awaiter(this, void 0, void 0, function* () { return false; }), previousPage = () => __awaiter(this, void 0, void 0, function* () { return false; }), }) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(reactstrap_1.Row, null,
            react_1.default.createElement(reactstrap_1.Col, { style: { display: "flex", justifyContent: "end" } }, pageFrom !== "Server" ? (react_1.default.createElement(gr_1.GrChapterPrevious, { size: "35px", onClick: (e) => firstPageHandle(firstPage), style: { cursor: "pointer" } })) : ("")),
            ...
            react_1.default.createElement(reactstrap_1.Col, { style: { display: "flex", justifyContent: "start" } }, pageFrom !== "Server" ? (react_1.default.createElement(gr_1.GrChapterNext, { size: "35px", onClick: (e) => lastPageHandle(lastPage), style: { cursor: "pointer" } })) : ("")))));
}
