...
function TableCompenent({ columns, data, filter, sort, }) {
    ...
    const sortHandle = (accessor, dataType) => {
        const sort = (argData) => {
            argData.sort((a, b) => {
                let aValue;
                let bValue;
    ...
    return (react_1.default.createElement(reactstrap_1.Row, { style: {
            maxHeight: "500px",
            overflowY: "auto",
        } },
            ...
            react_1.default.createElement("thead", null,
                react_1.default.createElement("tr", null, columns.map((col, index) => {
                    return (react_1.default.createElement("th", { key: index },
                        ...
                        sort == true ? (react_1.default.createElement(fa_1.FaSort, { style: { cursor: "pointer" }, onClick: () => sortHandle(col.accessor, col.dataType) })) : (""),
                        filter == "Column" || filter == "Both" ? (react_1.default.createElement(reactstrap_1.Input, { type: "text", value: fillterObj[col.accessor], onChange: (e) => filterOnChangeHandle(e, col.accessor), placeholder: `Search by ${col.accessor}` })) : ("")));
                }))),
